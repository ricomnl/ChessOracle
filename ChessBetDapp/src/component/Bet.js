...
export default class Bet extends Component {
    ...
    renderError() {
        return (
            <div>
                ...
                <div><h2>Our apologies, Chess Bet is not available at this time</h2><Digital size={20} /></div>
            </div>); 
    }
    ...
    renderPlaceBet() {
        return (
            <div>
                <h2>Place Bet</h2>
                <p>Enter an amount and a guess to place a new bet... (1 for white, 2 for black, 3 for tie)</p>
                <div className="pure-form pure-form-aligned">
                    <fieldset>
                        ...
                        <div className="pure-control-group">
                            ...
                            <input id="name" type="number" placeholder="Guess"
                                   min="1" max="3"
    ...
    render() {
        ...
        let errorView = this.renderLoading("Chess Bet is having problems...", fail);;
        if(this.state.error) {
            return errorView; 
        }
